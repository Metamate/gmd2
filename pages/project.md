...
- A "how to play"-section (i.e. input, actions, game modes, etc..)
...
The game project is used as reference and talking point at the exam and as such, can be worked on up until the day of the exam. It is however expected that students have a working version of the game to showcase at the final session of the course.
